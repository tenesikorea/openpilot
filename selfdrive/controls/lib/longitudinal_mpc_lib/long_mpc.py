...
tenesidzcost = Params().get("Tenesi_dz_cost", encoding="utf8")
tenesidzcostenable = Params().get_bool('Tenesi_dz_cost_enable')
...
if tenesidzcostenable: # 옵션에서 테스트 ON일때
  DANGER_ZONE_COST = int(tenesidzcost) #100.
else:
  DANGER_ZONE_COST = 70.
