...
from selfdrive.assets.dtc.dhmdps_uds import UdsClient, MessageTimeoutError, SESSION_TYPE, DTC_GROUP_TYPE

parser = argparse.ArgumentParser(description="clear DTC status")
parser.add_argument("addr", type=lambda x: int(x,0), nargs="?", default=0x7D4) # default is functional (broadcast) address
