...
from common.params import Params #테네시
...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    self.STEER_DELTA_DOWN = 6 # 핸들복귀 양
    self.STEER_DRIVER_ALLOWANCE = 50 #수동개입시 풀리는 단위..
    ...
    if Params().get_bool('Steer_409'): # 제네시스 DH 조향토크 409로 만들기 옵션 테스트용
      self.STEER_MAX = 409 # 제네시스 DH 조향토크 409로 만들기 옵션 테스트용
...
class CAR:
  ...
  # Genesis
  GENESIS_DH = "GENESIS DH 2013-2016"  # HYUNDAI_GENESIS = 차량이름을 변경 GENESIS_DH로..
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.ELANTRA_2021: HyundaiCarInfo("Hyundai Elantra 2021-23", video_link="https://youtu.be/_EdYQtV52-c", harness_kit=Harness.hyundai_k),
  CAR.ELANTRA_HEV_2021: HyundaiCarInfo("Hyundai Elantra Hybrid 2021-23", video_link="https://youtu.be/_EdYQtV52-c", harness_kit=Harness.hyundai_k),
  CAR.GENESIS_DH: [
    HyundaiCarInfo("Hyundai Genesis 2015-16", harness_kit=Harness.hyundai_j),  # TODO: check 2015 packages
    HyundaiCarInfo("Genesis G80 2017", "All", harness_kit=Harness.hyundai_j),
  ],
  ...
  # Genesis
  CAR.GENESIS_DH: HyundaiCarInfo("Genesis DH 2013-16", min_enable_speed=19 * CV.MPH_TO_MS, harness_kit=Harness.hyundai_j), # TODO: check 2015 packages
...
CHECKSUM = {
  ...
  "6B": [CAR.KIA_SORENTO, CAR.GENESIS_DH],
}
...
LEGACY_SAFETY_MODE_CAR = {CAR.GENESIS_DH, CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ_PHEV, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_SORENTO, CAR.SONATA_LF, CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_FL, CAR.VELOSTER,
...
HYBRID_CAR = set(HYBRID_CAR) | set(values_community.HYBRID_CAR)
EV_CAR = set(EV_CAR) | set(values_community.EV_CAR)
LEGACY_SAFETY_MODE_CAR = set(LEGACY_SAFETY_MODE_CAR) | set(values_community.LEGACY_SAFETY_MODE_CAR)
