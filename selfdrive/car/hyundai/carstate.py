...
from common.params import Params #테네시추가
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    #ret.steerFaultTemporary = cp.vl["MDPS12"]["CF_Mdps_ToiUnavail"] != 0 or cp.vl["MDPS12"]["CF_Mdps_ToiFlt"] != 0 # 기능삭제테스트
    self.dhmdps_err = cp.vl["MDPS12"]["CF_Mdps_FailStat"] and cp.vl["MDPS12"]["CF_Mdps_ToiFlt"] # mdps작동불능시 1이 들어온다.. 즉 0이 아니면
    # cruise state
    ...
    NOT_GEAR = [CAR.KONA_EV, CAR.IONIQ_EV_2020]
# 테네시 현재기어단수 적용
    ...
    #ret.steerFaultTemporary = self.mdps_error_cnt > 500
    ...
    #print(can_mdps11)
    #can_mdps12 = cp.vl["MDPS12"]  # MDPS12 데이터를 본다..
    #print(can_mdps12)
  ...
  def get_can_parser(CP):
    ...
    signals = [
      ...
      #("CF_Mdps_FailStat", "MDPS12"),  # 테네시 추가 mdps고장코드CF_Mdps_ToiFlt
      #("CF_Mdps_ToiFlt", "MDPS12"),  # 테네시 추가 mdps고장코드
