...
// 테네시추가작업
    ...
    {"Tenesi_dz_cost", PERSISTENT}, // 차로 변경 가능한 속도 설정
    {"Tenesi_dz_cost_enable", PERSISTENT}, // 차로 변경 가능한 속도 설정-온오프
    //{"Tenesi_path_cost", PERSISTENT}, // 차로 변경 가능한 속도 설정
    //{"Tenesi_path_cost_enable", PERSISTENT}, // 차로 변경 가능한 속도 설정-온오프
    {"Tenesi_gap_enable", PERSISTENT}, // e2e acc 가감속 변경모드
