...
#Tenesi 테네시
    ...
    currentBrake @124; # # 브레이크 허드에 표시하기
...
struct CarState {
  ...
  # 기어단수 Tenesi
  currentGear @53 :Float32;
  # 엔진rpm
  currentErpm @54 :Float32;
  struct Tpms {
    fl @0 :Float32;
    fr @1 :Float32;
    rl @2 :Float32;
...
struct CarControl {
  ...
  struct HUDControl {
    ...
    enum AudibleAlert {
      ...
      cruiseOn @10;
      cruiseOff @11;
      ready @12; # 펭수 오파 작동준비 되면 인사!
      tautohold @13; # 오토홀드 음성
      tbadboy @14; # BSD 차량인식시 음성
      tready @15; # 오픈파일럿 시작시 음성
      tyes @16; # 인게이지시 음성 펭수 yes yes
    }
  }
